...
import com.ss.automaticrecorder.receivers.MyLocalBroadcastReceiver;
...
public class MyRecordingRecyclerViewAdapter extends RecyclerView.Adapter<MyRecordingRecyclerViewAdapter.ViewHolder> implements Handler.Callback, MyLocalBroadcastReceiver.OnNewRecordingListener {
    ...
    MyRecordingRecyclerViewAdapter(final Context context, RecordingFragment.SORT_TYPE type, RecordingFragment.OnListFragmentInteractionListener listener) {
    ...
    private PhoneCallRecord[] getSelectedRecords() {
