...
public class AppPreferences {
    ...
    public void setRecordingEnabled(boolean enabled) {
        preferences.edit().putBoolean("RecordingEnabled", enabled).apply();
    }
    ...
    public void setRecordingIncomingEnabled(boolean enabled) {
        preferences.edit().putBoolean("RecordingIncomingEnabled", enabled).apply();
    }
    ...
    public void setRecordingOutgoingEnabled(boolean enabled) {
        preferences.edit().putBoolean("RecordingOutgoingEnabled", enabled).apply();
    }
    ...
    public File getFilesDirectory() {
        ...
        boolean isDirectoryCreated= myDir.exists();
    ...
    public void setFilesDirectory(String path) {
        ...
        preferences.edit().putString("FilesDirectory", path).apply();
    }
    ...
    public void setOlderThan(OlderThan olderThan) {
        preferences.edit().putString("OlderThan", olderThan.name()).apply();
    }
