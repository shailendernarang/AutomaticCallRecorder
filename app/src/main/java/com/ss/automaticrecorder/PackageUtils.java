...
public class PackageUtils {
	...
	public static String getConfigurationClass(Context context) throws RuntimeException {
		...
		try {
			...
			if (ai.metaData != null) {
				Object value = ai.metaData.get("ca.ss.config_class");
		...
		if (null == config_class) {
			throw new RuntimeException(
					"AndroidManifest.xml MUST implement <Application <meta-data android:name=\"ca.ss.config_class\" android:value=\"ca.ww.some_package.some_class\" /> />");
		}
		return config_class;
	}
