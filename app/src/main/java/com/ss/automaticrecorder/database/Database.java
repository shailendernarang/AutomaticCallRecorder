package com.ss.automaticrecorder.database;
...
public class Database extends SQLiteOpenHelper {
    ...
    private String CREATE_CALL_RECORDS_TABLE = "CREATE TABLE records(_id INTEGER PRIMARY KEY, phone_number TEXT, outgoing INTEGER, start_date_time INTEGER, end_date_time INTEGER, path_to_recording TEXT, keep INTEGER DEFAULT 0, backup_state INTEGER DEFAULT 0 )";
    ...
    public synchronized ArrayList<CallLog> getAllCalls() {
        ...
        Cursor cursor = db.rawQuery("select * from " + Database.CALL_RECORDS_TABLE+" order By "+Database.CALL_RECORDS_TABLE_ID +" DESC", null);
    ...
    public synchronized ArrayList<CallLog> getAllCalls(boolean outgoing) {
        ArrayList<CallLog> array_list = new ArrayList<CallLog>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select * from " + Database.CALL_RECORDS_TABLE + " where " + Database.CALL_RECORDS_TABLE_OUTGOING + "=" + (outgoing ? "1" : "0")+" order By "+Database.CALL_RECORDS_TABLE_ID +" DESC", null);
